...
export type ShortUrlDetailLinkProps = Record<string | number, unknown> &
  PropsWithChildren & {
...
export const ShortUrlDetailLink: FC<ShortUrlDetailLinkProps> = ({ shortUrl, suffix, asLink, children, ...rest }) => {
  ...
  return (
    <Link to={buildUrl(routePrefix, shortUrl, suffix)} {...rest}>
      {children}
    </Link>
  );
};
