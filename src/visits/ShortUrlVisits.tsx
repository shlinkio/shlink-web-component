...
const ShortUrlVisitsBase = boundToMercureHub<ShortUrlVisitsProps>(
  ({ ReportExporter: reportExporter }) => {
    ...
    const exportCsv = useCallback(
      (visits: NormalizedVisit[]) =>
        reportExporter.exportVisits(`short-url_${shortUrl?.shortUrl.replace(/https?:\/\//g, '')}_visits.csv`, visits),
